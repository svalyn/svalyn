...
public class AssessmentLastModifiedByDataFetcher implements DataFetcher<Account> {
    ...
    public AssessmentLastModifiedByDataFetcher(AccountSearchService accountSearchService) {
    ...
    public Account get(DataFetchingEnvironment environment) throws Exception {
        ...
        return this.accountSearchService.findById(assessment.getCreatedBy()).orElse(null);
    }
