...
@DgsComponent
public class MutationAddMemberToProjectDataFetcher {

    private final UserDetailsService userDetailsService;

    private final ProjectMembershipUpdateService projectMembershipService;

    public MutationAddMemberToProjectDataFetcher(UserDetailsService userDetailsService,
    ...
    @DgsData(parentType = "Mutation", field = "addMemberToProject")
    public IPayload get(@InputArgument("input") AddMemberToProjectInput input) {
