...
@DgsComponent
public class MutationRemoveMemberFromProjectDataFetcher {

    private final UserDetailsService userDetailsService;

    private final ProjectMembershipUpdateService projectMembershipService;

    public MutationRemoveMemberFromProjectDataFetcher(UserDetailsService userDetailsService,
    ...
    @DgsData(parentType = "Mutation", field = "removeMemberFromProject")
    public IPayload get(@InputArgument("input") RemoveMemberFromProjectInput input) {
